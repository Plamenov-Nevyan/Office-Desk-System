...
export function ListItem({ desk, index, isOwnedDesks }) {
  ...
  const toggleEditForm = (e) => {   //toggle between confirmation modal and edit form
    if (showEditForm) {
      ...
      setConfModalData((oldData) => {
        return { ...oldData, deskId: e.target.id };
      });
  ...
  const onEditConfirm = (e) => {
    ...
    toggleEditForm();
    setConfModalData((oldData) => {
      return { ...oldData, show: true, action: "edit" };
    });
  };
  ...
  const onDeleteConfirm = (e) => {
    ...
    setConfModalData(() => {
      return { show: true, action: "delete", deskId: e.target.id };
    });
  };
  const editFormValsChange = (e) =>
    setEditFormValues((oldVals) => {
          ...
          <form className={styles["edit-form"]}>
            <fieldset>
              ...
              <input
                ...
                onChange={(e) => editFormValsChange(e)}
              />
            </fieldset>
            <fieldset>
